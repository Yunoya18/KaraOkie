...
//        miport img
        ImageIcon mini = new ImageIcon("C:\\Users\\aompp\\OneDrive\\Documents\\NetBeansProjects\\project\\src\\Rectangle 18.png");
        Image min = mini.getImage().getScaledInstance(1150, 650, Image.SCALE_SMOOTH);
        Icon minimain = new ImageIcon(min);
        ImageIcon l = new ImageIcon("C:\\Users\\aompp\\OneDrive\\Documents\\NetBeansProjects\\project\\src\\Rectangle 29.png");
        Image lef = l.getImage().getScaledInstance(680, 600, Image.SCALE_SMOOTH);
        Icon left = new ImageIcon(lef);
        ImageIcon bl = new ImageIcon("C:\\Users\\aompp\\OneDrive\\Documents\\NetBeansProjects\\project\\src\\Rectangle 30.png");
        Image bill = bl.getImage().getScaledInstance(600, 40, Image.SCALE_SMOOTH);
        Icon billtxt = new ImageIcon(bill);
        ImageIcon sr = new ImageIcon("C:\\Users\\aompp\\OneDrive\\Documents\\NetBeansProjects\\project\\src\\Group 13.png");
        Image srch = sr.getImage().getScaledInstance(120, 100, Image.SCALE_SMOOTH);
        Icon search = new ImageIcon(srch);
        ImageIcon mm = new ImageIcon("C:\\Users\\aompp\\OneDrive\\Documents\\NetBeansProjects\\project\\src\\Group 19.png");
        Image mem = mm.getImage().getScaledInstance(120, 100, Image.SCALE_SMOOTH);
        Icon member = new ImageIcon(mem);
        ImageIcon cl = new ImageIcon("C:\\Users\\aompp\\OneDrive\\Documents\\NetBeansProjects\\project\\src\\Group 21.png");
        Image cls = cl.getImage().getScaledInstance(120, 100, Image.SCALE_SMOOTH);
        Icon close = new ImageIcon(cls);
        ImageIcon cn = new ImageIcon("C:\\Users\\aompp\\OneDrive\\Documents\\NetBeansProjects\\project\\src\\Group 22.png");
        Image can = cn.getImage().getScaledInstance(120, 100, Image.SCALE_SMOOTH);
        Icon cancel = new ImageIcon(can);
        ImageIcon dl = new ImageIcon("C:\\Users\\aompp\\OneDrive\\Documents\\NetBeansProjects\\project\\src\\Group 24.png");
        Image del = dl.getImage().getScaledInstance(120, 100, Image.SCALE_SMOOTH);
        Icon delete = new ImageIcon(del);
        ImageIcon ed = new ImageIcon("C:\\Users\\aompp\\OneDrive\\Documents\\NetBeansProjects\\project\\src\\Group 26.png");
        Image edi = ed.getImage().getScaledInstance(120, 100, Image.SCALE_SMOOTH);
        Icon edit = new ImageIcon(edi);
        ImageIcon ca = new ImageIcon("C:\\Users\\aompp\\OneDrive\\Documents\\NetBeansProjects\\project\\src\\Rectangle 61.png");
        Image ch = ca.getImage().getScaledInstance(400, 60, Image.SCALE_SMOOTH);
        Icon cash = new ImageIcon(ch);
        ImageIcon cr = new ImageIcon("C:\\Users\\aompp\\OneDrive\\Documents\\NetBeansProjects\\project\\src\\Rectangle 54.png");
        Image cd = cr.getImage().getScaledInstance(400, 60, Image.SCALE_SMOOTH);
        Icon credit = new ImageIcon(cd);
        ImageIcon ci = new ImageIcon("C:\\Users\\aompp\\OneDrive\\Documents\\NetBeansProjects\\project\\src\\Rectangle 34.png");
